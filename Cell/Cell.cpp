...
// Method to remove chromosomes with incorrect base pairs
  Cell::void removeIncorrectPairs()
  {
    int pos = 0;
  ...
  Cell::string complementary(string s)
  {
    for (auto &i : s)
    {
      i = complement[i];
 ...
 Cell:: vector<int> computeLPS(string pattern)
  {
  ...
  Cell::void translocationMutation(string S1, int n, string S2, int m)
  {
  ...
  Cell::void inversionMutation(string s1, int chrom_num)
  {
    int i = 0, j = 0, r = 0, p = 0, s = 0;
    string S2 = s1;
 ...
 Cell::string convertToNewString(const string &s)
  {
    string newString = "@";
 ...
 //This method find allthe complementary palindromes nucleotide sequence in DNA
  Cell::void findComplementaryPalindromes(int m)
  {
  ...
  Cell::void shortMutation(char o, char r, int num, int chorm_num)
  {
